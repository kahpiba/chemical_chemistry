...
export const MoleculeControls: React.FC<MoleculeControlsProps> = ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
      ...
      {/* Floating HUD Controls Container (positioned inside the 3D Canvas wrapper) */}
      <div style={{ position: 'relative' }}>
        ...
        <div className="mol-hud-top-right">
          ...
          <button className="hud-btn" onClick={onOpenDetails} title="Detail Senyawa">
            <Info size={18} />
          </button>
        </div>
        ...
        <div className="mol-bottom-dock-container">
            ...
            <div className="legend-chips-list">
              {elementLegend.map((item) => (
                <div
                  ...
                  title={`${item.name} (${item.element}): ${item.count} atom (${item.percentage}% komposisi)`}
                >
                  <span
          ...
          {/* Bottom Dock: Explode Slider (inspired by human-atlas) */}
