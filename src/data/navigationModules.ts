...
export const NAV_CATEGORIES: NavCategoryGroup[] = [
  {
    ...
    items: [
      ...
      {
        id: 'molecules',
        title: 'Molekul 3D & Kisi Kristal',
        shortDesc: 'Eksplorasi ikatan kimia, urai struktur & kisi kristal padatan 3D',
        badge: 'Kisi Kristal',
        iconName: 'Boxes',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        shortDesc: 'Aparatus buret kaca, kurva sigmoid pH & anotasi titik ekuivalen',
        badge: 'Analitik',
        iconName: 'Pipette',
      },
      {
        id: 'stoichiometry',
        title: 'Penyetara Reaksi & Tabel MRS',
        shortDesc: 'Matriks Gauss-Jordan, tabel MRS & kalkulator % yield',
        badge: 'Tabel MRS',
        iconName: 'Scale',
      },
      {
        id: 'flame',
        title: 'Uji Nyala & Spektroskopi Bohr',
        shortDesc: 'Spektra emisi nyala, deret hidrogen Balmer & lampu tabung gas',
        badge: 'Spektroskopi',
        iconName: 'Flame',
      },
    ],
